...
if not PlayerGui then repeat wait() until Player.PlayerGui ~= nil end
...
local function TweenFrame(GuiObj,Starting,Goal,Check,FunctionWhenComplete)
	if Check == true then
		...
		GuiObj.Visible = true
		GuiObj:TweenPosition(Goal,'Out','Quint',.5,false,FunctionWhenComplete or nil)
	else
		GuiObj:TweenPosition(Goal,'Out','Quint',.5,false,FunctionWhenComplete or nil)
	end
end

local function TweenTwoSubsequently(FirstObj,SecondObj,FirstObjGoal,SecondObjGoal,FirstObjStarting,SecondObjStarting,CheckFirst,CheckSecond,FunctionWhenComplete)
	...
	FirstObj:TweenPosition(FirstObjGoal,'Out','Quint',.5,false,function()
		if Enum.TweenStatus.Completed then
			SecondObj:TweenPosition(SecondObjGoal,'Out','Quint',.5,false,FunctionWhenComplete or nil)
		end
	end)
end
...
local function TweenTrigger(Type)
	if Type == 1 then
		OpenButton:TweenPosition(UDim2.new(1.1,0,0.5,0),'Out','Quint',.5)
	elseif Type == 2 then
		OpenButton:TweenPosition(UDim2.new(0.995,0,0.5,0),'Out','Quint',.5)
	end
end
...
OpenButton.MouseButton1Click:Connect(function()
	TweenFrame(Base,UDim2.new(1.5,0,.5,0),UDim2.new(.5,0,.5,0),true)
	TweenTrigger(1)
end)

BaseControlsDonate.MouseButton1Click:Connect(function()
	TweenTwoSubsequently(Base,Donate,UDim2.new(1.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(1.5,0,.5,0),true,true)
end)

BaseControlsCredits.MouseButton1Click:Connect(function()
	TweenTwoSubsequently(Base,Credits,UDim2.new(1.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(1.5,0,.5,0),true,true)
end)

BaseControlsX.MouseButton1Click:Connect(function()
	repeat wait() until Base.Position == UDim2.new(.5,0,.5,0)
	TweenTrigger(2)
	TweenFrame(Base,UDim2.new(.5,0,.5,0),UDim2.new(1.5,0,.5,0),false,function()
		Base.Visible = false
	end)
end)
...
CreditsControlsX.MouseButton1Click:Connect(function()
	repeat wait() until Credits.Position == UDim2.new(.5,0,.5,0)
	CreditsCanvas.CanvasPosition = Vector2.new(0,0)
	TweenTwoSubsequently(Credits,Base,UDim2.new(1.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(1.5,0,.5,0),true,true)
end)
...
DonateControlsX.MouseButton1Click:Connect(function()
	repeat wait() until Donate.Position == UDim2.new(.5,0,.5,0)
	TweenTwoSubsequently(Donate,Base,UDim2.new(1.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(.5,0,.5,0),UDim2.new(1.5,0,.5,0),true,true)
end)